...
#category options
        ...
        lagunalocate = pd.read_csv(src='lagunaloc/lagunamap.csv')
 ...
 #marking a map
            ...
            if pos['Analysis'].count() > 0 or neg['Analysis'].count() > 0 or  neu['Analysis'].count() > 0:
                ...
                if pos['Analysis'].count() > neg['Analysis'].count() and  pos['Analysis'].count() > neu['Analysis'].count():
                    iconemote = folium.features.CustomIcon(src='images/happy.png', icon_size=(45,45))
                    ...
                    iconemote = folium.features.CustomIcon(src='images/sad.png', icon_size=(45,45))
                    folium.Marker([location_info['lat'],location_info['long']] ,tooltip=folium.Tooltip(location_info['name']), icon=iconemote).add_to(lagunamap)
                
                else:
                    iconemote = folium.features.CustomIcon(src='images/neutral.png', icon_size=(45,45))
                    folium.Marker([location_info['lat'],location_info['long']] ,tooltip=folium.Tooltip(location_info['name']), icon=iconemote).add_to(lagunamap)

            else:
                iconemote = folium.features.CustomIcon(src='images/na.png', icon_size=(45,45))
                folium.Marker([location_info['lat'],location_info['long']] ,tooltip=folium.Tooltip(location_info['name']),icon=iconemote).add_to(lagunamap)
    ...
    st.write("Legend:")
    legend = Image.open(src="images/legend.png")
...
def wordcloud():
    ...
    #wordlocud pic
    maskpic = np.array(Image.open(src='images/facebooklogo.png'))
